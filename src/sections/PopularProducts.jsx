      ...
      <div className="flex flex-1 flex-col justify-start gap-5">
        <div className="flex justify-between font-bold">
          ...
          <Link to="/products" aria-label="Browse popular products">
            <button
              className="group flex items-center justify-center gap-3 rounded-md p-3 text-brand-6 hover:rounded-full hover:bg-brand-6 hover:text-brand-0.5 focus:outline-none focus:ring-2 focus:ring-brand-6 focus:ring-offset-2 max-xs:hidden lg:m-2"
